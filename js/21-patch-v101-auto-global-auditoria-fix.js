...
(function(){
  ...
  function ensureCss(){safe(function(){
    ...
    st.textContent = [
      ...
      'html body .chat-popover.tomauno-chat-visitor{width:min(330px,calc(100vw - 18px))!important;height:min(58vh,520px)!important;max-height:min(58vh,520px)!important;}',
  ...
  if(typeof oldAbrirChatAdmin==='function'){
    window.abrirChatAdmin=function(chatId){
      ...
      safe(function(){
        if(chatId && typeof db!=='undefined'&&typeof ref!=='undefined'&&typeof update!=='undefined') update(ref(db,'tomauno/chats/'+chatId),{unreadAdmin:false,waitingHuman:false}).catch(function(){});
